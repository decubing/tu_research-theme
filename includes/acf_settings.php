...
if( function_exists('acf_add_local_field_group') ):
  ...
  acf_add_local_field_group(array(
    ...
    'fields' => array(
      ...
      array(
        'key' => 'field_5f0cbec971659',
        'label' => 'Custom Applicant Question 1',
        'name' => 'custom_applicant_question_1',
        'type' => 'text',
        'instructions' => '',
        'required' => 0,
        'conditional_logic' => 0,
      ...
      array(
        'key' => 'field_5f0cbee77165a',
        'label' => 'Custom Applicant Question 2',
        'name' => 'custom_applicant_question_2',
        'type' => 'text',
        'instructions' => '',
        'required' => 0,
        'conditional_logic' => 0,
